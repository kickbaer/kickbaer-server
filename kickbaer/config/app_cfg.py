# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in kickbaer-server.
...
import kickbaer
from kickbaer import model, lib
...
base_config.model = kickbaer.model
base_config.DBSession = kickbaer.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "455367a1-9daa-40a2-9b3b-7d2e573e6263"
